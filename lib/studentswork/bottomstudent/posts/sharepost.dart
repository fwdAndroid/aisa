...
class ShareInChat extends StatefulWidget {
  PostModel posts;
  ShareInChat({required this.posts});

  @override
  _ShareInChatState createState() => _ShareInChatState();
}

class _ShareInChatState extends State<ShareInChat> {
  @override
                            ...
                            if (widget.posts.type == "image") {
                              groups
                                ...
                                showDialog(
                                    context: context,
                                    builder: (_) =>
                                        LogoutOverlay(message: "Post Shared"));
