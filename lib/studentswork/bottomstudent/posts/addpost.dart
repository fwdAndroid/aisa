...
class AddPost extends StatefulWidget {
  ...
  AddPost({required this.location});

  @override
  _AddPostState createState() => _AddPostState(location: location);
}

class _AddPostState extends State<AddPost> {
  late String location;
  _AddPostState({required this.location});
                    ...
                    onPressed: () {
                      if (formkey.currentState!.validate()) {
                        if (selectedfile != null) {
                          ...
                          var postprovider = Provider.of<PostFunctions>(context,
                              listen: false);
                          postprovider
                              .addpost(
                                  context,
