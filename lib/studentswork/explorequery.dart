...
import 'bottomstudent/bottompages/post.dart';

// ignore: must_be_immutable
class ExploreQuery extends StatefulWidget {
  String query;
  ExploreQuery({required this.query});

  @override
  _ExploreQueryState createState() => _ExploreQueryState();
}

class _ExploreQueryState extends State<ExploreQuery> {
  bool isliked = false;
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: userpost.where("category", isEqualTo: widget.query).snapshots(),
  ...
  Widget postsshow(likesdata, QuerySnapshot data, index, String userid,
      String usercity, String username, String userprofile) {
